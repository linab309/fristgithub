...
static uint16 myTempReportPeriod = 1000;     // milliseconds
static uint16 myBatteryCheckPeriod = 5000;   // milliseconds
...
void zb_HandleOsalEvent( uint16 event )
{
  ...
  if ( event & MY_REPORT_TEMP_EVT )
  {
    ...
    zb_SendDataRequest( 0x00, SENSOR_REPORT_CMD_ID, 2, pData, 0, AF_ACK_REQUEST, 0 );
